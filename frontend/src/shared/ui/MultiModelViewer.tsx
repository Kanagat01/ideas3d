...
type MultiModelViewerProps = {
  models: (ModelData & { onClick: () => void; key: string })[];
};
...
export function MultiModelViewer({ models }: MultiModelViewerProps) {
  const [hovered, setHovered] = useState<{
    md: ModelData;
    x: number;
    y: number;
    ...
    <div style={{ position: "relative" }}>
      ...
      {hovered && (
        ...
        >
          {hovered.md.tooltip}
          {!hovered.md.url && (
            <div style={{ color: "#c00", fontWeight: 600, marginTop: 4 }}>
